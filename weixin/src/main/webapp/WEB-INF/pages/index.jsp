...
<script type="text/javascript">	
$(function(){ 
// 	$.post("pageMenuTree", {}, function(menuTreeList) {
// 		var vm = new Vue({
// 			el : '#menu_style',
// 			data : {
// 				okk : "菜鸟教程",
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home"><a href="javascript:void(0)"
							name="home" class="iframeurl" title="">
							<i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a>
						</li>
						<c:forEach items="${treeList}" var="tree">
							<li><a href="#" class="dropdown-toggle">
									<i	class="icon-desktop"></i>
									<span class="menu-text"> ${tree.cName } </span>
									<b	class="arrow icon-angle-down"></b>
								</a>
								<ul class="submenu">
									<c:forEach items="${tree.subMenu}" var="subTree">
										<li class="home">
											<a href="javascript:void(0)"
												name="${subTree.cUrl}" title="${subTree.cTitle}" class="iframeurl">
											<i	class="icon-double-angle-right"></i>${subTree.cName}
											</a>
										</li>
									</c:forEach>
								</ul>
...
<!-- 						<li v-for="item in menuTree"> -->
<!-- 							<a href="#" class="dropdown-toggle"> -->
<!-- 								<i	class="icon-desktop"></i> -->
<!-- 								<span class="menu-text"> {{item.cName}} </span> -->
<!-- 								<b	class="arrow icon-angle-down"></b> -->
<!-- 							</a> -->
<!-- 							<ul class="submenu"> -->
<!-- 								<li v-for="subItem  in item.subMenu" class="home"> -->
<!-- 									<a href="javascript:void(0)" -->
<!-- 										name="Products_List.html" title="{{subItem.cName}}" class="iframeurl"> -->
<!-- 									<i	class="icon-double-angle-right"></i>{{subItem.cName}} -->
<!-- 									</a> -->
<!-- 								</li> -->
<!-- 							</ul> -->
<!-- 						</li> -->
           ...
           $("#menu_style").niceScroll({  
			...
			<div class="main-content">
				...
				<iframe id="iframe"
					...
					name="iframe" frameborder="0" src="home"> </iframe>
